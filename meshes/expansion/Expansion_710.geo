...
//+
Transfinite Curve {-2, 15, 5, -12} = 4 Using Progression 1.02; //Nodos axiales
//+
Transfinite Curve {-1, 17, 8, 16, -18, -9} = 3 Using Progression 1.35; //Nodos dirección Hartmann en el canal pequeño
//+
Transfinite Curve {3, -7, 13, -11, -14, 10, -4, 6} = 3 Using Progression 1.35; //Nodos dirección Hartmann en el canal pequeño
...
//+
Extrude {0.0,0.0,2.0} {
    Surface{1,2}; Layers{{1,3,1}, {0.1,0.9,1}}; Recombine; 
}
