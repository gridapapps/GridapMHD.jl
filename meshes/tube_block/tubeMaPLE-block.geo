...
Transfinite Curve {1, 2, 3, 4, 5, 6 , 7, 8} = N_a;

//Radial nodes

Transfinite Curve {9, 10, 11, 12} = N_r Using Progression r;
...
// Extrusion
Extrude {0.0,0.0,L} {Surface{1, 2, 3, 4, 5}; Layers{N_L};} 
